...
## Table 4: Turnout and satisfaction with democracy, all panels (without CZ 2023)
```{r}
...
## Table 5: SWD change, CZ 2023 panel
```{r}
...
all_panels <- all_panels %>% 
  mutate(age = normalize_scale(age))
...
## Appendix Table A: Descriptive stats
```{r}
...
cze <- cz_2023_all_waves_resp %>% 
  ...
  mutate(variable = case_when(
    variable == "voted_1r" ~ "Turned out (1st round)",
    variable == "voted_2r" ~ "Turned out (2nd round)",
    variable == "stable_voter" ~ "Stable winner",
    variable == "voted" ~ "Turned out",
