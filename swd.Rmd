...
## H1
```{r}
pl_lm1_1 <- glm(voted ~ swd_w1 + age + age^2 + gender + edu, data = pl_2019)

tab_model(list(pl_lm1_1))
```
...
## H1
```{r}
hu_lm1_1 <- glm(voted ~ swd_w1 + age + age^2 + gender + edu, data = hu_2019)

tab_model(list(hu_lm1_1))
```
...
## H1
```{r}
de_lm1_1 <- glm(voted ~ swd_w18 + sex, data = de_2021_final)

tab_model(list(de_lm1_1))
```
...
## H5
```{r}
de_lm5_0 <- lm(swd_diff ~ winner_government + stable_voter + swd_w18,
               data = de_2021_final)
de_lm5_1 <- lm(swd_diff ~ winner_government * stable_voter + swd_w18,
               data = de_2021_final)
de_lm5_0b <- lm(swd_diff ~ winner_government + stable_voter + swd_w18,
               data = de_2021_final %>% filter(kp20_2601 != "Berlin"))
de_lm5_1b <- lm(swd_diff ~ winner_government * stable_voter + swd_w18,
               data = de_2021_final %>% filter(kp20_2601 != "Berlin"))
